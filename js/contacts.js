...
/* function activateInputError() {
    let emailField = docID('email');
    let parentDiv = docID('email-contacts');
...
function generateContactHTML(i) {
    return `
        <div class="selected-contact-main-container">
            <div class="open-nav-button d-none mybtn" onclick="showNav()">
            ...
            <div class="edit-area_bottom-area d-flex_column">
                <form id="edit-contact-form" onsubmit="editContact(event, ${i}); return false;">
                    ...
                    <div id="edit-button-container" class="button_container d-flex_row">
                        <div onclick="clearEditForm()" id="delete_in_edit" class="blue-button-container d-flex_row mybtn">
